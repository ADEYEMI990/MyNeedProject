    ...
    <div>
      ...
      <div className= 'my-10 flex flex-col md:flex-row gap-16'>
        ...
        <div className= 'flex flex-col justify-center gap-6 md:w-2/4 text-gray-600'>
          <p>At MyNeeds, fashion is more than just clothing it's a celebration of individuality and self-expression. Born from a passion for creativity and a love for quality craftsmanship, we set out to redefine the shopping experience. Our journey began with a simple belief: everyone deserves to feel confident and stylish in their own skin.</p>
          <p>Each piece in our collection tells a story, blending timeless designs with contemporary trends. We source sustainable materials and collaborate with talented artisans to ensure every item is crafted with care. Our mission is to empower you to embrace your unique style while making mindful choices.</p>
